 ...
 * this complicates configuration because the com.LibraryProject.PABLibrary.security policy needs to be changed by the user to allow the driver to read them :(
 */
