...
public class ExportControlled {
    ...
    private static String[] getAllowedCiphers(PropertySet pset, ServerVersion serverVersion, String[] socketCipherSuites) {
        ...
        if (!StringUtils.isNullOrEmpty(enabledSSLCipherSuites)) {
            ...
            // We don't disable DH algorithm. That allows c/J to deal with custom server builds with different com.LibraryProject.PABLibrary.security restrictions.
            ...
            // Java 8 default java.com.LibraryProject.PABLibrary.security contains jdk.tls.disabledAlgorithms=DH keySize < 768
    ...
    public static SSLContext getSSLContext(String clientCertificateKeyStoreUrl, String clientCertificateKeyStoreType, String clientCertificateKeyStorePassword,
        ...
        try {
            ...
            throw ExceptionFactory.createException(SSLParamsException.class,
                    "Default algorithm definitions for TrustManager and/or KeyManager are invalid.  Check java com.LibraryProject.PABLibrary.security properties file.", nsae,
