...
public class NativeProtocol extends AbstractProtocol<NativePacketPayload> implements Protocol<NativePacketPayload>, RuntimePropertyListener {
    ...
    static {
        ...
        //
        // Use the I/O system to get the encoding (if possible), to avoid com.LibraryProject.PABLibrary.security restrictions on System.getProperty("file.encoding") in applets (why is that
        // restricted?)
        //
        try {
